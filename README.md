...
Esta aplicacion credada para practicar el manejo de interaccion con el usuario creado con:
...
git clone https://github.com/web-luisaguilar/lecture-list.git
cd lecture-list
...
Puedes obtener una vista previa del proyecto en el siguiente [link](https://luisaguilar-lecturelist.netlify.app)
...
- Diseño de Josh W. Comeau para una aplicación de libros pendientes de leer: [link](https://twitter.com/JoshWComeau/status/1678893330480898049)

- Dribbble con rediseño de Goodreads: [link](https://dribbble.com/shots/2523654-Books-listing-page-goodreads)

- Concepto de uso de arrastrar libros: [link](https://dribbble.com/shots/19351938-Mybooks-Page-Board)

- Concepto de landing para una aplicación de libros: [link](https://dribbble.com/shots/16279204-Book-Web-Store-Concept)
